#Написал программу, которая создает директорию "Oleg Kuleshov" и в этой директории создает 10 текстовых 
#файлов с названием "текст1.txt", "текст2.txt", ..., "текст10.txt",
